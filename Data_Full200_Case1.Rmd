...
```{r}
##Scenario 1-  Log-logistic times - less predictive covariates
## Repeated simulation
...
n_sims <-1000 # At each sample size we repeat n_sims times
setup_seed <-42  # 
...
write_csv(Results, file="New_data_setSimu200.csv")